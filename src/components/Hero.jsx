...
bg-linear-to-br from-indigo-50 to-emerald-50 dark:from-gray-900 dark:to-gray-800"
    >
      <div className="text-center max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 text-gray-700 dark:text-gray-300">
          I'm a <span className="text-primary">Full Stack Developer</span> (MERN) from Wayanad, Kerala. 
          I build fast, scalable web apps with clean UI & real-world functionality.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            download
            className="px-8 py-4 border-2 border-primary text-primary font-semibold 
